...
export const DEFAULT_SETTINGS: BWCSettings = {
  sanitisation: {
    removeHTMLComments: false,
    removeMDComments: false,
  },
  storedMetrics: {
    words: {
      id: 'words',
